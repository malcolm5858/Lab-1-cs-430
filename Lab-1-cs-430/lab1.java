...
public class lab1 {
    ...
    public static long[] run(int arraySize) { // main backend function
        ...
        insertionTime = System.currentTimeMillis() - start; // subtract current system time from start value to get
                                                            // performance results

        // System.out.println(Arrays.toString(insertionResult)); //prints sorted array
        ...
        mergeTime = System.currentTimeMillis() - start; // subtract current system time from start value to get
                                                        // performance results

        // System.out.println(Arrays.toString(mergeResult)); //prints sorted array to
